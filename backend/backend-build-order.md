...
**Build order within this phase deviates from the numbering below, per the user's explicit choice (2026-07-23): 9 → 10 → 7, skipping 8 for now.**

7. **AI Tasks** — auto-placement into free slots, deadline-aware backward planning, session-splitting for large tasks, basic "what should I work on next" as a priority-score sort (table #4, #5, #7, #18). Building third, after 9 and 10.
8. **AI Habits** — best-time placement, reflow on conflict (table #6). Not yet scheduled — skipped for now.
...
10. **Buffer Time** — breaks, travel, prep/follow-up padding (table #11). Building second.
